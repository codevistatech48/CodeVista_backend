...
const srsRequestSchema = new mongoose.Schema(
  {
    ...
    goals: { type: String, default: '', trim: true, maxlength: 4000 },
    audience: { type: String, default: '', trim: true, maxlength: 4000 },
    features: { type: String, required: true, trim: true, maxlength: 8000 },
    userRoles: { type: String, default: '', trim: true, maxlength: 4000 },
    integrations: { type: String, default: '', trim: true, maxlength: 4000 },
    technology: { type: String, default: '', trim: true, maxlength: 4000 },
    timeline: { type: String, default: '', trim: true, maxlength: 160 },
    budget: { type: String, default: '', trim: true, maxlength: 160 },
    notes: { type: String, default: '', trim: true, maxlength: 5000 },
    status: {
      type: String,
      enum: ['pending', 'approved', 'accepted', 'rejected', 'expired', 'completed'],
      default: 'pending',
      index: true,
    },
...
srsRequestSchema.index(
  { user: 1 },
  { unique: true, partialFilterExpression: { status: { $in: ['pending', 'approved', 'accepted'] } } }
);
